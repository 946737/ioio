                        ...
                        <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                            ...
                            <form class="validate-form mt-2" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" name="save_general" class="btn btn-relief-primary mt-2 mr-1">Simpan</button>
                                        <button type="reset" class="btn btn-relief-danger mt-2">Batal</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="tab-pane fade" id="account-vertical-password" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                            <form class="validate-form" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" name="save_password" class="btn btn-relief-primary mr-1 mt-1">Simpan</button>
                                        <button type="reset" class="btn btn-relief-danger mt-1">Batal</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="tab-pane fade" id="account-vertical-poin" role="tabpanel" aria-labelledby="account-pill-poin" aria-expanded="false">
                            <form class="validate-form" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" name="wd" class="btn btn-relief-primary mr-1 mt-1">Tukar Point</button>
                                        <button type="reset" class="btn btn-relief-danger mt-1">Batal</button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="tab-pane fade" id="account-vertical-pin" role="tabpanel" aria-labelledby="account-pill-pin" aria-expanded="false">
                            <form class="validate-form" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" name="save_pin" class="btn btn-relief-primary mr-1 mt-1">Simpan</button>
                                        <button type="reset" class="btn btn-relief-danger mt-1">Batal</button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="tab-pane fade" id="account-vertical-api" role="tabpanel" aria-labelledby="account-pill-api" aria-expanded="false">
                            <form method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" name="u_api" class="btn btn-relief-primary mr-1 mt-1">Simpan</button>
                                        <button type="reset" class="btn btn-relief-danger mt-1">Batal</button>
                                    </div>
                                </div>
                            </form>
